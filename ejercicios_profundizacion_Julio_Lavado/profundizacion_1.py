...
if diferencia > 0:
  res_1 = 1
  print(f'La diferencia es positivo :  {diferencia}; El codigo asignado es {res_1}')

elif diferencia < 0:
  res_1 = 2
  print(f'La diferencia es negativo:  {diferencia}; El codigo asignado es {res_1}')

elif diferencia == 0:
  res_1 = 3
  print(f'La diferencia es CERO; El codigo asignado es {res_1}')
