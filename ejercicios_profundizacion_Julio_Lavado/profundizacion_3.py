...
respuesta_ing = input(f"Primera pregunta: {pregunta_1} : ")

if respuesta_ing.lower() == respuesta_1:
...
respuesta_ing = input(f"Segunda pregunta: {pregunta_2} : ")

if respuesta_ing.lower() == respuesta_2:
    # Si la respuesta es correcta
    # aumentar puntaje
    print("¡Muy bien!\n")
    puntaje += 10
...
respuesta_ing = input(f"Tercera pregunta: {pregunta_3} : ")

if respuesta_ing.lower() == respuesta_3:
    # Si la respuesta es correcta
    # aumentar puntaje
    print("¡Muy bien!\n")
    puntaje += 10
...
respuesta_ing = input(f"Cuarta pregunta: {pregunta_4} : ")

if respuesta_ing.lower() == respuesta_4:
    # Si la respuesta es correcta
    # aumentar puntaje
    print("¡Muy bien!\n")
    puntaje += 10
...
respuesta_ing = input(f"Quinta pregunta: {pregunta_5} : ")

if respuesta_ing.lower() == respuesta_5:
    # Si la respuesta es correcta
    # aumentar puntaje
    print("¡Muy bien!\n")
    puntaje += 10
